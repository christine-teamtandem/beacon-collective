...
const ComposedMessage = ({ senderName, senderRole, subject, body }: Props) => {
  ...
  return (
    <Html lang="en" dir="ltr">
      <Head />
      <Preview>{subject || `A message from ${BRAND_NAME}`}</Preview>      <Body style={main}>
        <Container style={outer}>
          ...
          <Section style={footerSection}>
            ...
            <Text style={footerSub}>{BRAND_TAGLINE}</Text>            <Text style={footerLinks}>
            ...
            <Text style={footerSub}>
              You received this because you are a member of {BRAND_NAME}.            </Text>
          </Section>
...
export const template = {
  ...
  subject: (data: Record<string, any>) =>
    data.subject || `Message from ${BRAND_NAME}`,  displayName: 'Hub composed message',
  previewData: {
